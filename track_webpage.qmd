...
If you want to also exclude GoatCounter from counting visits to the webpage from your phone, you can add that IP address too. Google how to find your IP address on your phone (Iphone, android, etc) and follow the instructions. In my case, with an android, I have to go to "Settings", "About phone", and scroll down to a section called "IP address". I am not so sure entering that IP address actually worked though.
However, note that GoatCounter will not manage to exclude the vists you make from your computer if you use a VPN.
