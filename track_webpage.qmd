...
Then, I took the URL embeded in the JavaScript code that GoatCounter provides on my personal page. I added this to the _quarto.yml file with the following code in the YML
website:
  analytics:
    goatcounter: https://USERNAME.goatcounter.com/count

Then I saved the changes and rendered them.
